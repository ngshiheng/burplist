...
* fix(deps): update dependency alembic to v1.9.2 ([`7fad6b4`](https://github.com/ngshiheng/burplist/commit/7fad6b482fcf1cc3bfd5ca38aaa6f1091804f1af))
...
* fix(deps): update dependency sqlalchemy to v1.4.46 ([`c31a78f`](https://github.com/ngshiheng/burplist/commit/c31a78fcd3ae5dad5585e3ca2b92091e2b653762))
...
chore(deps): update dependency flake8 to v6 ([`b375e9d`](https://github.com/ngshiheng/burplist/commit/b375e9d4a689eb8d2cdd2a4244388256f27139c7))
...
* chore: add setuptools ([`973f3c5`](https://github.com/ngshiheng/burplist/commit/973f3c53a3c552e42fe0577523133b5524cb5824))
...
* style: update docstring ([`fc1ecfe`](https://github.com/ngshiheng/burplist/commit/fc1ecfe99d5d160878edec7ad28c8c380379dec5))
...
* fix(deps): update dependency sentry-sdk to v1.6.0 ([`973d0aa`](https://github.com/ngshiheng/burplist/commit/973d0aa81ed57fc45992a244f2163cd077c68e9e))
...
* chore: run poetry update ([`7a8636c`](https://github.com/ngshiheng/burplist/commit/7a8636c27ca3c570b7ee86978ef1e2d47c771250))
...
* style: ordering and line break ([`1dd31af`](https://github.com/ngshiheng/burplist/commit/1dd31afb419028650ea9983434eb122abf6f7947))
...
* docs: update semantic commit url ([`6f2976e`](https://github.com/ngshiheng/burplist/commit/6f2976e94efe6e8d53d8ab839204f15943612720))
...
* chore(deps): update dependency flake8 to v4 ([`aa8e5c3`](https://github.com/ngshiheng/burplist/commit/aa8e5c39cd90b7e8012923c9693b696fcbf585e7))
...
* refactor: rework redmart spider to use lazada api; exclude more mainstream beer brands ([`b67611c`](https://github.com/ngshiheng/burplist/commit/b67611ce68b9f3f7c3374cc3b1fed574fd77f984))
...
chore: add automerge for non-major update ([`209f28d`](https://github.com/ngshiheng/burplist/commit/209f28d95c43a5dd7c090a1acc8fb2808fa2883b))
...
* Remove str conversion at spider level and compare prices in Decimal ([`b7a54a2`](https://github.com/ngshiheng/burplist/commit/b7a54a2c48479e5fb70881f1ae4685144439f285))
...
* Parse image_url for troublebrewing ([`ac3991b`](https://github.com/ngshiheng/burplist/commit/ac3991b6df95f0ed3bb05a99728a67bd2ddfd802))
...
* Fix incorrect price error ([`d4f653b`](https://github.com/ngshiheng/burplist/commit/d4f653b2b07e6ae6ecaa84d2cf1d244103542ffd))
...
* Create zero state migration for existing database ([`600340d`](https://github.com/ngshiheng/burplist/commit/600340d56415b4a101350b1425c32de688b0a9c6))
...
* Fix where  could be returned as  or  by the API ([`fbb3363`](https://github.com/ngshiheng/burplist/commit/fbb3363dc5f9981e1648db00cdf67c4fdcfd4a2c))
...
* Fix bug where parse_quantity is called twice in alcohaul ([`15fab94`](https://github.com/ngshiheng/burplist/commit/15fab9425bc0dba244f412f01485f53902991250))
...
Major refactoring ([`ef21f40`](https://github.com/ngshiheng/burplist/commit/ef21f407b2f6852c3883dbc749283ce422602010))

* 🧹 Clean up codebase and add some notes ([`ea76c70`](https://github.com/ngshiheng/burplist/commit/ea76c7017c277f30b2526b98d4323635a2335bca))

* Update hopshop spider with new database model ([`f9100ac`](https://github.com/ngshiheng/burplist/commit/f9100ac13a946a1e4ee5a58bec5eb28c602f210b))

* Update craftbeersg spider with new database model ([`b92ad57`](https://github.com/ngshiheng/burplist/commit/b92ad5775d27dcd946c81bb5cc62969d9d49b5ab))

* Update troublebrewing spider ([`06a3286`](https://github.com/ngshiheng/burplist/commit/06a32866667c30a977cce9eb0a5b2d08157a9ce6))

* Update ishopchangi spider ([`bd7e95d`](https://github.com/ngshiheng/burplist/commit/bd7e95dadf34d050133bdbc516c6da470c8f7115))

* Add style parser ([`889806e`](https://github.com/ngshiheng/burplist/commit/889806e559ee0e0d9e95b9ab48305dc66b3be396))

* Update SQL example ([`2c23f80`](https://github.com/ngshiheng/burplist/commit/2c23f80418926f188a584f262ede909ef2efa595))

* Remove lazada and shopee spiders for now ([`d916005`](https://github.com/ngshiheng/burplist/commit/d9160051c82b7537f11fa991a7424f373ff25d8d))

* Make thirsty spider start crawling from &#39;browse by beer style page&#39; in order to get beer style ([`50117ea`](https://github.com/ngshiheng/burplist/commit/50117ea0ba2de46938787d039a917603bc559473))

* Use follow_all ([`ecaf325`](https://github.com/ngshiheng/burplist/commit/ecaf325a16a28febb42102b7f3e940bc3b589fd1))

* Update thirsty spider with the latest database model ([`d74ab1d`](https://github.com/ngshiheng/burplist/commit/d74ab1d95c79b35fcc1335e71f607932896933c7))

* Update ExistingProductPricePipeline to update product info ([`808f797`](https://github.com/ngshiheng/burplist/commit/808f7978239685717f61162cee4615ee45b6dda4))

* Update beerforce spider ([`71807e7`](https://github.com/ngshiheng/burplist/commit/71807e76d7aaa16e4d04967eb238e582b67c12cf))

* Add fallback when some ABV are displayed only as int ([`b36c89f`](https://github.com/ngshiheng/burplist/commit/b36c89f23640d603c7bb68d5ab7e37e0f83ebe0a))

* Make column nullable ([`bbcd3b5`](https://github.com/ngshiheng/burplist/commit/bbcd3b5979371696977f3e3121c465dcc4bc22e3))

* Remove old tests and brewerkz spider ([`66543e0`](https://github.com/ngshiheng/burplist/commit/66543e0e8ef3c4e9dfcffe6aabd7a43c3be58e88))

* Update to support new database models ([`98a54ed`](https://github.com/ngshiheng/burplist/commit/98a54edacd5c21451845455f5b664a5415fa98cd))

* Add more parsers ([`f689c3d`](https://github.com/ngshiheng/burplist/commit/f689c3d1f2d19da8a0c21169b588eb15e5583a3d))

* Update database models ([`00b0da6`](https://github.com/ngshiheng/burplist/commit/00b0da68113c0629d105fbc540d7ebcc8e4f5188))

* Remove remdart spider and scrape only craft beer data for some sites ([`d8025c5`](https://github.com/ngshiheng/burplist/commit/d8025c560428059ede661bf69d584acff382cadb))

* Update vendor to platform ([`7ddcb43`](https://github.com/ngshiheng/burplist/commit/7ddcb43cbd36c09abbad6662c4e52aaf60b52763))

* Update regex ([`ff5ebd0`](https://github.com/ngshiheng/burplist/commit/ff5ebd07f1efbacd499a47046c15e4dad54ea69e))

* Merge pull request #40 from ngshiheng/add-shopee-spider

Add shopee spider ([`926a7f6`](https://github.com/ngshiheng/burplist/commit/926a7f683869177cefcef238bd737d1807ca0274))

* Add shopee spider ([`62b3f97`](https://github.com/ngshiheng/burplist/commit/62b3f97d539d4ace17f07f51dc590d1c40010d51))

* Update reference link ([`a7f0c18`](https://github.com/ngshiheng/burplist/commit/a7f0c18a7070cc2d234ff25f2e9b2919beb214d6))

* Remove duplicated prices before commiting to DB ([`cfdefdf`](https://github.com/ngshiheng/burplist/commit/cfdefdfd84b050dbf9fde88c0344fea130adfdb5))

* Refactor ishopchangi to use regex groups ([`a480fc0`](https://github.com/ngshiheng/burplist/commit/a480fc0b59f4c6124b20839d0c90c79de3cbd885))

* Refactor brewerkz spider to use get_product_name_quantity ([`d0e7f76`](https://github.com/ngshiheng/burplist/commit/d0e7f76c27b6229fc19e3ca31e160c04bff8ed74))

* Use regex groups ([`1cea872`](https://github.com/ngshiheng/burplist/commit/1cea87275b5e596516189b7c742bc992dfeabb5b))

* Add comments about additional product information that could be scraped ([`bb919d0`](https://github.com/ngshiheng/burplist/commit/bb919d0903617d74728a0b93c764d29a6d63ccd3))

* Make sure product url always starts with https ([`e4b1d1a`](https://github.com/ngshiheng/burplist/commit/e4b1d1a71b8a2834dcb475b226586eeaa165eb6d))

* Merge pull request #38 from ngshiheng/add-lazada-spider

Add lazada spider ([`24c8489`](https://github.com/ngshiheng/burplist/commit/24c8489aacbf1be4c25f3b7f06fbadb0094c6006))

* Remove headers because it is automatically populated ([`0cc1bca`](https://github.com/ngshiheng/burplist/commit/0cc1bcaedbe1d0e67af45618fa7d89ccccda7a13))

* Disable HTTPCACHE for redmart due to failing retries ([`a210462`](https://github.com/ngshiheng/burplist/commit/a210462f7f31bcfcc5164e9077fbe898c0123672))

* Fix case where using custom_settings completely left out global DOWNLOADER_MIDDLEWARES ([`dc62336`](https://github.com/ngshiheng/burplist/commit/dc623368e02c5d206ee958660e3c6ec522cc8016))

* Make use of productInfo from redmart&#39;s API ([`dcef1cc`](https://github.com/ngshiheng/burplist/commit/dcef1cc580ae2ecaa1f9ba47a680ae542a967591))

* Add DelayedRequestsMiddleware to add delay in between retries ([`1be9a51`](https://github.com/ngshiheng/burplist/commit/1be9a51c4077493dcde3e85870df1b2170cc5544))

* Add get_retry_request to retry requests ([`2a0bfad`](https://github.com/ngshiheng/burplist/commit/2a0bfad5ce0eec228f23dd3dc4ba69948d39bf5d))

* Refactoring ([`9720886`](https://github.com/ngshiheng/burplist/commit/9720886a47df4b9d41065a40d0e6bde1da6a8b7e))

* Update redmart spider to scrape from a single URL first ([`8a30fd9`](https://github.com/ngshiheng/burplist/commit/8a30fd9935cc6ac7b184a8a0e5844e7c58086dc3))

* Add redmart spider ([`79bf5a7`](https://github.com/ngshiheng/burplist/commit/79bf5a748df692603950c77d3c07810edfcecff4))

* Add long DOWNLOAD_DELAY for lazada spider ([`963763b`](https://github.com/ngshiheng/burplist/commit/963763b449648352bdab70013200c53904336b7a))

* Use middleware to automatically rotate User-Agent in request headers ([`33609de`](https://github.com/ngshiheng/burplist/commit/33609de681bc30e8c3d00921d3e7d7ba7f92c058))

* Add scrapy-fake-useragent ([`e5c6f6d`](https://github.com/ngshiheng/burplist/commit/e5c6f6d153c064cca2f1154bf815312acf025a47))

* Make lazada spider use rotating proxy ([`c011dc2`](https://github.com/ngshiheng/burplist/commit/c011dc25843614a3b389c8adcc7260561786c3b7))

* Add lazada spider ([`9b37aee`](https://github.com/ngshiheng/burplist/commit/9b37aee2e5ee49c3bf30e25584732b617bc34922))

* Add useful SQL queries ([`a6b5653`](https://github.com/ngshiheng/burplist/commit/a6b5653f11f3e8279b7d0471185c761904122ae1))

* Merge pull request #36 from ngshiheng/add-ishopchangi-spider

Add ishopchangi spider ([`02358c0`](https://github.com/ngshiheng/burplist/commit/02358c0b163cb877a99d8e8ede66589753832371))

* Add test for ishopchangi and fix trailing comma name ([`441e7e5`](https://github.com/ngshiheng/burplist/commit/441e7e55065535c1282d6aab964c5aadd4864891))

* Add ishopchangi spider ([`7fbdc12`](https://github.com/ngshiheng/burplist/commit/7fbdc12353d492a3b8ecc48a842abf5de0099aea))

* Add index to product name ([`e4328c9`](https://github.com/ngshiheng/burplist/commit/e4328c92c11422acb238e3a4ff3560ed4d7d613c))

* Merge pull request #33 from ngshiheng/add-troublebrewing-spider

Add troublebrewing spider ([`78e8e73`](https://github.com/ngshiheng/burplist/commit/78e8e73f39c842c8236a364ec4f9fd3b5fe874a0))

* Temporarily disable statsmailer ([`1fd4a46`](https://github.com/ngshiheng/burplist/commit/1fd4a4633cf8d4db93257f5236d4132d7395a170))

* Add pylint and fix pylint warnings ([`dc42aab`](https://github.com/ngshiheng/burplist/commit/dc42aab977715c528ab9ac0878cc38577379d3f0))

* Dependencies update ([`42d0226`](https://github.com/ngshiheng/burplist/commit/42d0226b181ab54cbd1e7a36640ceb72bd3d9f55))

* Add troublebrewing spider ([`7d6f426`](https://github.com/ngshiheng/burplist/commit/7d6f42684241ef431b281d220cccb4965399d75e))

* Update README ([`6bdaa3b`](https://github.com/ngshiheng/burplist/commit/6bdaa3b29a4d58ca4661048be3b46539a98f42f4))

* Add Sentry warning whenever  and  have different length ([`1ca19a3`](https://github.com/ngshiheng/burplist/commit/1ca19a3c21205c37db8a37c514b9a83fa0feca8c))

* Merge pull request #32 from ngshiheng/add-hopshop-spider

Add hopshop spider ([`14b16a8`](https://github.com/ngshiheng/burplist/commit/14b16a8ff45186042b88454ba12a911a92096e41))

* Add hopshop spider ([`e0ca36c`](https://github.com/ngshiheng/burplist/commit/e0ca36cca1960283b38023301f55e344b58bfdb9))

* Merge pull request #30 from ngshiheng/fix-last-price-bug

Fix CardinalityViolation bug with Product.last_price ([`76c0e6f`](https://github.com/ngshiheng/burplist/commit/76c0e6fe2930f31ea6abf1ac9252472a8a92ee71))

* Update settings to only send email in production ([`67e4610`](https://github.com/ngshiheng/burplist/commit/67e46105e6457a89b191b7cf715e78dbae0eb211))

* Fix CardinalityViolation bug with Product.last_price ([`069c17c`](https://github.com/ngshiheng/burplist/commit/069c17c9d55692b56cd389adddf338d264d2263a))

* Merge pull request #29 from ngshiheng/add-email-notification

Use StatsMailer extension to send Scrapy info ([`76c9d0c`](https://github.com/ngshiheng/burplist/commit/76c9d0c2460ff436bc0b6840cfc83fb5b81244a7))

* Use StatsMailer extension to send Scrapy info ([`2ef73f9`](https://github.com/ngshiheng/burplist/commit/2ef73f98068fad4f3f126f79a3a318bff04f71c3))

* Update README instructions ([`9692be9`](https://github.com/ngshiheng/burplist/commit/9692be9dc19dd0939e2b0aaec200c3237baed2a9))

* Uncomment scrapy commands ([`73c0240`](https://github.com/ngshiheng/burplist/commit/73c02405fab54ec34af483699338d323aa118f17))

* Add task.sh for Heroku Scheduler to run spiders ([`b70f22a`](https://github.com/ngshiheng/burplist/commit/b70f22a21d51e016751c278ad06bda3bbc2cf753))

* Set ROBOTSTXT_OBEY False for thirsty spider ([`acabfae`](https://github.com/ngshiheng/burplist/commit/acabfae473ee56ec45c9a186ca461afcddaa49f5))

* Fix bug where we constantly run into UniqueViolation because fairprice API returns duplicated item ([`f983ec4`](https://github.com/ngshiheng/burplist/commit/f983ec43ee740e866a8ba6f09a8a7106d74fb7ba))

* Merge pull request #27 from ngshiheng/update-database-model

Update database model ([`066122c`](https://github.com/ngshiheng/burplist/commit/066122c7b37ffbf7d00f03d83691ca72e57cc70d))

* Fix brewerkz spider bug where it attemps to scrape duplicated data on side panel ([`a56adee`](https://github.com/ngshiheng/burplist/commit/a56adee8a1efc9de9589c491c932947f4a9c878e))

* Add UniqueConstraint for Product quantity and url ([`dd7dd11`](https://github.com/ngshiheng/burplist/commit/dd7dd11ff300e4c0f75348713d729dcb81eaecfb))

* Merge pull request #23 from ngshiheng/bug-fixes

Fix issue where duplicated products are created when there is a change in price ([`66d36ed`](https://github.com/ngshiheng/burplist/commit/66d36ed9239abf1255098804c3d0709e65e887dc))

* Fix issue where duplicated products are created when there is a change in price ([`b9aa520`](https://github.com/ngshiheng/burplist/commit/b9aa5201aab995a067e92d899b4846be13bc3cc9))

* Prettier README ([`720b321`](https://github.com/ngshiheng/burplist/commit/720b321afcf7c284792bad3e5680cf17ca9e9878))

* Add gif to README ([`0c4219a`](https://github.com/ngshiheng/burplist/commit/0c4219a66bb79cf65bbb375ac4961e41405ebbbe))

* Read database name from environment variable ([`eae84c7`](https://github.com/ngshiheng/burplist/commit/eae84c7d11d96d6b70775a7c10d9683c5e8e9db8))

* Merge pull request #13 from ngshiheng/zyte-deployment

Update Sentry integration and code refactoring ([`6622534`](https://github.com/ngshiheng/burplist/commit/6622534bf0e248038277e4aae2b4655fef3a5e1f))

* Remove sample output ([`825ae4e`](https://github.com/ngshiheng/burplist/commit/825ae4e55892282d6b4f16324e8d137c228c8c18))

* Add additional test case for trailing &#39;s&#39; ([`58b9a7b`](https://github.com/ngshiheng/burplist/commit/58b9a7ba5514526bd2c95590f7cdbb4372fb6d54))

* Add basic brewerkz spider ([`7d494d6`](https://github.com/ngshiheng/burplist/commit/7d494d6c38a44fe87eac52912f4a6439c0350cf7))

* Use bulk_insert_mappings for even faster performance ([`8901ac3`](https://github.com/ngshiheng/burplist/commit/8901ac3ac4a35d4f48a5c068a66d47f73f7389ae))

* Allow Sentry transaction and use SqlalchemyIntegration ([`0c3095f`](https://github.com/ngshiheng/burplist/commit/0c3095f698534a12a86a46df399ae8a4b3bd1b7e))

* Update README ([`a81ae4a`](https://github.com/ngshiheng/burplist/commit/a81ae4a2436999ec3299aa2cbb03b08ae5017b54))

* Update documentations ([`69ee0b5`](https://github.com/ngshiheng/burplist/commit/69ee0b586193698c323b7d5478154d96018366c6))

* Merge pull request #11 from ngshiheng/code-refactoring

Code refactoring and improvements ([`04d7bab`](https://github.com/ngshiheng/burplist/commit/04d7bababd854946234db982d06f0d23f65f2aca))

* Use bulk operation to insert new products and prices to DB ([`67c0e6f`](https://github.com/ngshiheng/burplist/commit/67c0e6fa26b57c0516742f0251e3a4b73e6a0472))

* Ignore .scrapy/ generated by httpcache ([`2808722`](https://github.com/ngshiheng/burplist/commit/2808722be0c5a38e6b2aa290d538985163600c49))

* Enable AUTOTHROTTLE_ENABLED and HTTPCACHE_ENABLED ([`5d90aab`](https://github.com/ngshiheng/burplist/commit/5d90aab5f00549724fe2f554a0a83eae40c9f1ef))

* Fix timeout error issue where SQLAlchemy hits QueuePool limit due to unclosed session ([`a7f8f9f`](https://github.com/ngshiheng/burplist/commit/a7f8f9f26c6662f72e347f7f83e17c8cf3a41cf4))

* Add column_property to query for last_price and set Sentry environment ([`5f5e96c`](https://github.com/ngshiheng/burplist/commit/5f5e96c17cdf9d829144aa48757fcfe51d192df1))

* Add ipython ([`597a0da`](https://github.com/ngshiheng/burplist/commit/597a0da6cea99bcf3384d3d7bd30777fa2c614e9))

* Merge pull request #10 from ngshiheng/color-logging

Color logging ([`b931c2e`](https://github.com/ngshiheng/burplist/commit/b931c2e8301183d838653484d7fa2e63e8e26973))

* Fix bug where discounted product price is not extracted ([`ee178d5`](https://github.com/ngshiheng/burplist/commit/ee178d5e382cfa0b0fe49b18496722b40a1ccb05))

* Fix bug where condition check should be &#39;is True&#39; not &#39;is None&#39; ([`b1c44a9`](https://github.com/ngshiheng/burplist/commit/b1c44a9c28ffcce2b4a440a11d9df84ecf02790f))

* Update sample output of all spiders ([`21d8eef`](https://github.com/ngshiheng/burplist/commit/21d8eef89197706341a468981b8ca83022a5a0df))

* Add unit tests ([`3bda2e1`](https://github.com/ngshiheng/burplist/commit/3bda2e1dcfecaa3499fd3fb93d2d1985c3ca3ff4))

* Set Sentry to use sentry-sdk ([`16a5f15`](https://github.com/ngshiheng/burplist/commit/16a5f155b8935d567129c12a8281be4cc181cfbd))

* Add colourized log ([`07db31a`](https://github.com/ngshiheng/burplist/commit/07db31a988313f5724d19d1b9ede6f80369ce0c7))

* Merge pull request #8 from ngshiheng/add-sentry

Add sentry and price parser ([`17853b1`](https://github.com/ngshiheng/burplist/commit/17853b150fa8b3726ef25960ded4cec8165f4a7e))

* Add NewProductPricePipeline and DuplicatePricePipeline ([`c4808b8`](https://github.com/ngshiheng/burplist/commit/c4808b8f9066a5690b31d45910bba3152e6d81dd))

* Update model and add pipeline to add item into database ([`53a63ec`](https://github.com/ngshiheng/burplist/commit/53a63ec822ca170306eba2b2cca7e32d4869384d))

* Add SQLAlchemy and some basic pipelines ([`bfcfbda`](https://github.com/ngshiheng/burplist/commit/bfcfbdad43e60b8a55cbbd8b1f20fcfc6c6d0342))

* Use price_parser and fix coldstorage bug where price element has different class name ([`3f9c3b0`](https://github.com/ngshiheng/burplist/commit/3f9c3b099aa1cdafa3227635df140bcc782e79fa))

* Add Sentry ([`62980c9`](https://github.com/ngshiheng/burplist/commit/62980c942637a80b795dd24728bf000ff79c58b6))

* Merge pull request #7 from ngshiheng/add-pipelines

Update coldstorage spider to scrape next pages ([`e0388f2`](https://github.com/ngshiheng/burplist/commit/e0388f23ae69537222bd5c1507c54287722c67e3))

* Update coldstorage spider to scrape next pages ([`77fa0a0`](https://github.com/ngshiheng/burplist/commit/77fa0a0839f8398d9d99306989e0195f08eb5216))

* Merge pull request #3 from ngshiheng/add-beerforce-spider

Add basic spider to scrape from beerforce.sg ([`f345ba8`](https://github.com/ngshiheng/burplist/commit/f345ba8a5ba3e82acea658936142bd6f86c67570))

* Clear flake8 errors ([`80bc7ba`](https://github.com/ngshiheng/burplist/commit/80bc7ba337e938c9f9cad3850cf42d35d52f82ff))

* Update alcoholdelivery sample output ([`bd3af22`](https://github.com/ngshiheng/burplist/commit/bd3af226ae6721c1093c6036c858ee57cf545494))

* Scrape product quantity from thirsty ([`720503a`](https://github.com/ngshiheng/burplist/commit/720503a85911b7c85e6d5f429d1e0d21bc01df08))

* Scrape product quantity from fairprice ([`95e5a59`](https://github.com/ngshiheng/burplist/commit/95e5a5978a0bc5e622a272d98ef621f0d181654e))

* Sanitize craftbeersg beer name and get product quantity ([`c0e98c9`](https://github.com/ngshiheng/burplist/commit/c0e98c928e2ee048b9ad5c0274d8da62664bb06a))

* Remove Unit Enum, change unit to quantity ([`f81765e`](https://github.com/ngshiheng/burplist/commit/f81765ec85d9245a1413cc72484a474a9439644b))

* Move example output folder ([`8da40ee`](https://github.com/ngshiheng/burplist/commit/8da40eec903601bb6f60f8a48390eaccc9b47089))

* Fix bug where beerforce spider did not recursively follow the link to next page ([`c398c72`](https://github.com/ngshiheng/burplist/commit/c398c72646fb9bbfb9fb8b3c56e9bdb982e00a8e))

* Update scrapy ItemLoader to parse price correctly ([`4e227ce`](https://github.com/ngshiheng/burplist/commit/4e227ce0c6a3bf75ff9d2b313e16c99ad203326b))

* Filter out kegs ([`73b89ca`](https://github.com/ngshiheng/burplist/commit/73b89ca93b2f2cd457527e285eeeec60f38880b8))

* Add basic spider for alcoholdelivery.com ([`f148bb3`](https://github.com/ngshiheng/burplist/commit/f148bb33d74c3588c224a9c7e533ed3f0984105c))

* Add basic spider to scrape from beerforce.sg ([`e4e45aa`](https://github.com/ngshiheng/burplist/commit/e4e45aacad8bb7c19f28e52a7bb4fd3ec6006ae0))

* Merge pull request #2 from ngshiheng/scaper-api-proxy

Use Scaper API as a proxy management measure ([`c9f6d3a`](https://github.com/ngshiheng/burplist/commit/c9f6d3a2ada78a7c83157744bf6e09cb49c80078))

* Use Scaper API as a proxy management measure ([`482cf70`](https://github.com/ngshiheng/burplist/commit/482cf70d2d04b05b275b6c38beceac9728fb176a))

* Merge pull request #1 from ngshiheng/add-craftbeersg-spider

Add basic spiders for all main sites ([`5f153c1`](https://github.com/ngshiheng/burplist/commit/5f153c1d38986f9bb10eb8e0b00b3b8e76575fd9))

* Add flake8 and scrapy check to github action ([`434dd2a`](https://github.com/ngshiheng/burplist/commit/434dd2a8249b72757d4350222e0bac6728264785))

* Add basic spider to scrape from thirsty.com ([`2265749`](https://github.com/ngshiheng/burplist/commit/2265749d7e76b4af1e97ed4ecb977a0a908ec93a))

* Scrape fairprice using their API ([`f4a142b`](https://github.com/ngshiheng/burplist/commit/f4a142b5fce49201100ac4e839d72acf8820ea3d))

* Add basic spider to scrape from fairprice.com ([`ab9b996`](https://github.com/ngshiheng/burplist/commit/ab9b9964277757dc24ee943aded66bfa36418496))

* Add scrapy-splash for selecting dynamically loaded content ([`b9fe2da`](https://github.com/ngshiheng/burplist/commit/b9fe2da657fe7980a05ccc449f300e67cfdb9409))

* Add basic spider to scrape from coldstorage.com ([`c816152`](https://github.com/ngshiheng/burplist/commit/c816152b5fbfcbe14e43847f97171d799d6d869a))

* Add basic spider to scrape from craftbeersg.com ([`6aabec3`](https://github.com/ngshiheng/burplist/commit/6aabec3b00b1586cd103344ecbfdabaa816415d4))

* Initialize scrapy project ([`eade821`](https://github.com/ngshiheng/burplist/commit/eade8217dca479a4c2b5c9660516445072c5ef1e))

* Initialize project ([`42e44e5`](https://github.com/ngshiheng/burplist/commit/42e44e5092250480bd7d2c3e4183e3a34df45633))
