...
class ShopeeSpider(scrapy.Spider):
    ...
    start_urls = [
        f'https://shopee.sg/api/v4/search/search_items?by=sales&categoryids=14260&keyword=craft%20beer&limit=50&match_id=14255&newest={n}&official_mall=1&order=desc&page_type=search&rating_filter=4&scenario=PAGE_SUB_CATEGORY_SEARCH&skip_autocorrect=1&version=2'
